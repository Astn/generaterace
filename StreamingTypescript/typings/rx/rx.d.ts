...
declare module Rx {
	...
	export interface Observable<T> {
		...
		groupBy<TKey, TElement>(keySelector: (value: T) => TKey, elementSelector: (value: T) => TElement, comparer: (value1: T, value2: T) => boolean): Observable<GroupedObservable<TKey, T>>;
